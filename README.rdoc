...
If sometimes you think you are a guinea pig, you can try the experimental completion system. To do it, use <tt>vf-comp.sh</tt> instead of <tt>vf.sh</tt>. If you use <tt>vf-comp.sh</tt>, be sure to load <tt>compinit</tt> before!
